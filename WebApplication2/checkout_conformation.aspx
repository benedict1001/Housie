<%@ Page Title="Today's Check-outs" Language="C#" MasterPageFile="~/hostmasterpage.Master" AutoEventWireup="true" CodeBehind="checkout_conformation.aspx.cs" Inherits="WebApplication2.checkout_conformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .btn-checkout:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(245, 158, 11, 0.4); color: white; }
        ...
        @media (max-width: 768px) {
            ...
            .btn-checkout { width: 100%; justify-content: center; margin-top: 15px; }
        }
    </style>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5 mb-5">
        <div class="glass-panel">
            <h1 class="page-title">Today's Check-outs</h1>
            <p style="color: #64748b; font-weight: 500; margin-bottom: 30px;">
                Review and confirm guests who are departing from your properties today.
            </p>

            <asp:Repeater ID="rptCheckouts" runat="server" OnItemCommand="rptCheckouts_ItemCommand">
                <ItemTemplate>
                    <div class="booking-card">
                        ...
                        <div>
                            <asp:LinkButton ID="btnConfirmCheckOut" runat="server" 
                                CssClass="btn-checkout" 
                                CommandName="ConfirmCheckOut" 
            ...
            <asp:Panel ID="pnlNoCheckouts" runat="server" Visible="false" CssClass="empty-state">
