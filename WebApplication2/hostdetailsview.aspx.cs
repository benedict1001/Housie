...
{
    public partial class hostdetailsview : System.Web.UI.Page
    {
        ...
        protected void btnReject_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                Response.Write("<script>alert('Host Rejected Successfully');window.location='hostapprovel.aspx';</script>");
            }
        }
    }
}