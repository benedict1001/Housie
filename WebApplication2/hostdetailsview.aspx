<%@ Page Title="Host Details View" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="hostdetailsview.aspx.cs" Inherits="WebApplication2.hostdetailsview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="details-container">
        ...
        <div class="action-area">
            <asp:Button ID="btnApprove" runat="server" Text="Approve Host" CssClass="btn btn-approve" OnClick="btnApprove_Click" />
            <asp:Button ID="btnReject" runat="server" Text="Reject / Block" CssClass="btn btn-reject" OnClick="btnReject_Click" OnClientClick="return confirm('Are you sure you want to reject this host?');" />
        </div>
    </div>
</asp:Content>